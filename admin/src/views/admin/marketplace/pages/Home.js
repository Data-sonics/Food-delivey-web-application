            ...
            data.map((item, index) => {
              return (
                <tr key={index}>
                  ...
                  <td>{item.rating}</td>
                  <td>
                    <img src={item.logo} alt="logo" className="image" />
                  </td>
                  <td>
                    <img src={item.coverimg} alt="cover" className="image" />
                  </td>
                  <td>{item.type}</td>
                  <td>
                    <Link
                      to={`https://data-sonics-project-admin.vercel.app/admin/restaurants/update/${item.id}`}
                    >
